...
<title>Система управления общежитиями</title>
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="white" size="6" >Система управления общежитиями</font></div>
		<div style="padding-top: 70px;padding-right: 20px;">текущий пользователь：&nbsp;<font color="red" >${currentUser.userName }</font></div>
	</div>
</div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					<li><a href="blank"><i class="icon-chevron-right"></i>начало</a></li>
					<li><a href="dormManager?action=list"><i class="icon-chevron-right"></i>Менеджер общежития Управление</a></li>
					<li><a href="student?action=list"><i class="icon-chevron-right"></i>управление студентами</a></li>
					<li><a href="dormBuild?action=list"><i class="icon-chevron-right"></i>Управление общежития</a></li>
					<li><a href="record?action=list"><i class="icon-chevron-right"></i>Записи об отсутствии на рабочем месте</a></li>
					<li><a href="password?action=preChange"><i class="icon-chevron-right"></i>изменить пароль</a></li>
					<li><a href="login.jsp"><i class="icon-chevron-right"></i>прервать</a></li>
				</ul>
			</div>
					<div class="span10">
