...
public class DormBuildServlet extends HttpServlet{
	...
	private String genPagation(int totalNum, int currentPage, int pageSize){
		...
		pageCode.append("<li><a href='dormBuild?page=1'>начало</a></li>");
		if(currentPage==1) {
			pageCode.append("<li class='disabled'><a href='#'>Предыдущая</a></li>");
		}else {
			pageCode.append("<li><a href='dormBuild?page="+(currentPage-1)+"'>Предыдущая</a></li>");
		}
		...
		if(currentPage==totalPage) {
			pageCode.append("<li class='disabled'><a href='#'>Следующая </a></li>");
		} else {
			pageCode.append("<li><a href='dormBuild?page="+(currentPage+1)+"'>Следующая</a></li>");
		}
		pageCode.append("<li><a href='dormBuild?page="+totalPage+"'>Последняя</a></li>");
